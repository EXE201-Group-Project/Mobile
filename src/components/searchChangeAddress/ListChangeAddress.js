...
// definition of the Item, which will be rendered in the FlatListChangeAddress
...
const ListChangeAddress = ({ data, searchPhrase, setSelectedItem, setID}) => {
...
export default ListChangeAddress;
